...
_G.packer_plugins = {
  ...
  ["lir.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/mortepau/.local/share/nvim/site/pack/packer/opt/lir.nvim"
  },
  ["lspsaga.nvim"] = {
...
vim.cmd [[nnoremap <silent> <leader>fT <cmd>lua require("packer.load")({'lir.nvim'}, { keys = "<lt>leader>fT", prefix = "" }, _G.packer_plugins)<cr>]]
